...
describe('/api/articles', () => {
  describe('GET', () => {
    ...
    test('GET - status: 200 - sort by comment_count', () => {
      return request(app)
    ...
    test('GET - status: 200 - sort by votes', () => {
      return request(app)
    ...
    test('GET - status: 200 - sort by created_at in ascending order', () => {
      return request(app)
    ...
    test('GET - status: 200 - sort by comment_count in ascending order', () => {
      return request(app)
    ...
    test('GET - status: 200 - sort by votes in ascending order', () => {
      return request(app)
    ...
    test('POST - status: 201 - responds with newly created comment', () => {
      ...
      return request(app)
        ...
        .then((response) => {
          ...
          expect(postedComment.body).toBe('this is the best news ever!');
...
describe('/api/articles?topic=mitch', () => {
  describe('GET', () => {
    test('GET - status: 200 - returns the correct information - topic query "mitch"', () => {
      return request(app)
    ...
    test('GET - status: 200 - returns the correct information  - topic query "cats"', () => {
      return request(app)
    ...
    test('GET - status: 200 - returns the correct information - topic query "paper"', () => {
      return request(app)
    ...
    test('GET - status: 400 - returns the correct information', () => {
      return request(app)
        .get('/api/articles?topic=DROP_TABLE')
        .expect(400)
        .then((response) => {
